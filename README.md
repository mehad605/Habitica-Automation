> 
>
> This project is a modified version of the original **[Automate Habitica](https://github.com/bumbleshoot/automate-habitica)** script by **[bumbleshoot](https://github.com/bumbleshoot/)**.
>
> ---
...
### Switch Equipment
Automatically switches equipment (added feature). To activate, run `createEquipmentReward` from the dropdown to create the reward in Habitica.

### Cast Burst of Flames
Enhanced mage skill casting (added feature). To activate, run `createBurstReward` from the dropdown to create the reward in Habitica. Specify the number of casts in the notes part of the reward.
...
1. Click [here](https://script.google.com/u/0/home/projects/1Y5_INdp1n9cHrBCddHLOeLYo6_FxG6bBQB1vJ-LfXNhiJtS6xqvzRXin) to go to the Automate Habitica script. If you're not signed into your Google account, click on "Start Scripting", then sign in, then click on the script link again.
...
14. For added features, run setup functions from the respective files:
    - Select "createEquipmentReward" from the dropdown and run to create the equipment switch reward in Habitica.
    - Select "createBurstReward" from the dropdown and run to create the burst of flames reward in Habitica. Specify the number of casts in the notes part of the reward.
